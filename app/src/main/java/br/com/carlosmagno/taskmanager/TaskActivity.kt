...
class TaskActivity : AppCompatActivity() {
    ...
    private fun openDatePicker(date: EditText, year: Int, month: Int, day: Int) {
        val datePickerDialog = DatePickerDialog(
            ...
            { _,
              ...
              dayOfMonth ->
                date.setText(
                    String.format("%02d/%02d/%04d", dayOfMonth, monthOfYear + 1, yearOfYear))
            },
            year,
            month,
            day);
    ...
    private fun openTimePicker(time: EditText, hour: Int, minute: Int) {
    ...
    private fun loadTask(title: EditText, description: EditText, date: EditText, time: EditText) {
    ...
    private fun saveTask(title: String, description: String, date: String, time: String) {
        if(task_id === "") {
            val task = hashMapOf(
                "title" to title,
            ...
            val dbRef = FirebaseDatabase.getInstance().getReference("users/${uid}/tasks/${task_id}")
